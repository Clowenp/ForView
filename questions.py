...
def readFile(filename : str = "static/questions.json"):
    """
    ...
    try:
        ...
        print("Error at 22, questions.py: the file questions.json has been moved. Please put the file back in its original location in \
               the data folder.")
        assert 1 == 0

    return database

def writeFile(contents : dict, filename : str = "static/questions.json"):
    """
...
def main():
    ...
    test = readQuestion()
    print([i for i in test.values()][0])
